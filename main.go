...
func journalHandler(w http.ResponseWriter, r *http.Request) {
	...
	case http.MethodPost:
		fmt.Println("http.MethodPost ,,g-recaptcha-response ")
		fmt.Println("g-recaptcha-response value =", r.FormValue("g-recaptcha-response"))
		{
			...
			fmt.Print("validate captcha function call")
